...
// export const profileUpdateDetailsAction = (email, username, first_name, last_name, phone_number, lat, lng) => async(dispatch, getState)=>{
//     try{
//         dispatch({
...
export const profileUpdateDetailsAction = (email, username, first_name, last_name, phone_number, address, lat, lng) => async(dispatch, getState)=>{
    try{
        dispatch({
            type: PROFILE_UPDATE_DETAILS_REQUEST
        })
