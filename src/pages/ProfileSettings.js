...
//                     // Handle error, optionally set default values
//                 }
//             );
//         }
...
//     const handleSubmit = (e) => {
//         e.preventDefault()
//         console.log("Latitude:", lat); // Log lat and lng before dispatching
...
//                                     </div>
//                                     <div className="sm:col-span-2">
//                                         <label className="block mb-2 mt-2 text-sm font-medium text-gray-900 dark:text-white">Latitude</label>
//                                         <TextInput
//                                             type='text'
//                                             value={lat}
//                                             placeholder='Latitude'
...
//                                     </div>
//                                     <div className="sm:col-span-2">
//                                         <label className="block mb-2 mt-2 text-sm font-medium text-gray-900 dark:text-white">Longitude</label>
//                                         <TextInput
//                                             type='text'
//                                             value={lng}
//                                             placeholder='Longitude'
